...
const Landing: React.FC<LandingProps> = ({ className }) => {
  return (
    <div className={`container-fluid ${className || ''}`}>
      {/* Hero Section */}
      <div 
        className="section center-align pikachu-landing-section"
        style={{ '--pikachu-bg': `url(${pikachuImage})` } as React.CSSProperties}
      ></div>

      {/* Section 1 */}
      <div 
        className="section center-align venusaur-landing-section"
        style={{ '--venusaur-bg': `url(${venusaurImage})` } as React.CSSProperties}
      >
      ...
      {/* Section 2 */}
      <div 
        className="section center-align mewtwo-landing-section"
        style={{ '--mewtwo-bg': `url(${mewtwoImage})` } as React.CSSProperties}
      >
